...
//17 查询基金日志
export function listfundlog(data) {
  return request({
    url: '/user/listfundlog',
    method: 'get',
    params:data
  })
}

export function checksbxx(data) {
  return request({
    url: '/user/checksbxx',
    method: 'get',
    params:data
...
//修改基金
export function modifyFund(data) {
  return request({
    url: '/user/modifyfund',
    method: 'post',
    data
...
//超级管理员admin 修改
export function onSubmitAdminModify(data) {
  return request({
    url: '/user/onSubmitAdminModify',
    method: 'post',
    data
  })
}
