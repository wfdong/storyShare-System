<template>
  <div class="app-container">
    ...
    <el-row type="flex" class="row-bg" justify="center" v-if="currentitem != null && currentitem.jokeTable !== null" :key="currentitem.jokeTable">
        ...
        <el-col :span="20">
           <div>
                ...
                <el-row>
                  ...
                  <p >{{currentitem.jokeTable.content}}</p>
                  <!--Tinymce ref="editor" style="width: 760px;" v-model="currentitem.jokeTable.content" :height="400" /-->
                </el-row>
                <el-row>
                   <el-col :span="2">
                    <a v-if="addLikeFlag==0" @click="addALike(currentitem.jokeTable)"><img height=25px width=25px src="../../../assets/laugh.png">{{ currentitem.jokeTable.liked }}</a>
                    <el-badge v-if="addLikeFlag==1" >
                     <el-button  type="primary" align="top" size="mini" icon="el-icon-loading" circle></el-button>
                    </el-badge>
                   </el-col>
                    
                   <el-col :span="2">
                    <a v-if="addDislikeFlag==0" @click="addADisLike(currentitem.jokeTable)"><img height=25px width=25px src="../../../assets/cry.png">{{ currentitem.jokeTable.disliked }}</a>
                    <el-badge v-if="addDislikeFlag==1" >
                     <el-button  type="primary" align="top" size="mini" icon="el-icon-loading" circle></el-button>
                    </el-badge>
                   </el-col>
                   ...
                   <el-col :span="6" align=right >
                    <span style="color: #b4bccc">
                       {{formatDate(currentitem.jokeTable.uploadtime)}}&nbsp;
                    </span>
                   </el-col>
                </el-row>
           </div>
      ...
      <div v-if="currentitem.jokeTable.liked==0">
            <el-rate align="right"
              v-model="currentitem.jokeTable.liked"
              disabled
              allow-half
              show-score
              text-color="#ff9900"
    ...
    <el-row v-for="curcomment in jokeCommentsDisplay" :key="jokeCommentsDisplay">
        ...
        <el-row>
          <el-col :span="24" align=right>
            <span style="color: #b4bccc">
                       {{formatDate(curcomment.updatetime)}}&nbsp;
               </span>
          </el-col>
        </el-row>
    </el-row>
