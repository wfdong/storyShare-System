...
#JAVA_OPTS="-server -Xms1048m -Xmx1048m -Xloggc:/home/admin/logs/app/gc.log"
JAVA_OPTS="-server -Xms524m -Xmx524m -Xloggc:/home/ubuntu/logs/app/gc.log"

# Java程序日志所在的目录
APP_LOG=/home/ubuntu/logs/app

# Java程序主体所在的目录，即classes的上一级目录
APP_HOME=../

# Java主程序，也就是main(String[] args)方法类
APP_MAIN=jokes.Application
